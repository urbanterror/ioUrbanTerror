...
typedef struct
{
	void *module;
	byte (*Run)(void);
	void (*NewPacket)(void *packet, size_t len);
} client_battleye_t;

extern client_battleye_t clbe;
#endif
...
// cl_battleye.c
//
extern void CL_BE_Load(void);
extern void CL_BE_Unload(void);
#endif
