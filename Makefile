...
$(B)/client/cl_battleye.o : $(CDIR)/cl_battleye.c; $(DO_CC)
...
$(B)/client/sv_battleye.o : $(SDIR)/sv_battleye.c; $(DO_CC)
...
$(B)/client/unix_lib.o : $(UDIR)/unix_lib.c; $(DO_CC)
...
$(B)/client/win_lib.o : $(W32DIR)/win_lib.c; $(DO_CC)
...
$(B)/ded/unix_lib.o : $(UDIR)/unix_lib.c; $(DO_DED_CC)
